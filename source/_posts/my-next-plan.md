...
收到了来自 IDP CN 顾问的[邮件](#附件1:2024-07-02收到的IDPCN邮件/)，本邮件、包括以后的所有邮件在去敏以后，都会附在本文的最后。这天是我的夜班，所以我在凌晨才来得及[回复邮件](#附件2:2024-07-03发出的邮件/)，我向顾问提出了几个问题，并询问签约时间等情况，回复内容一并附在后面。

### 2024-07-03：

收到了 IDP CN 顾问回复的[邮件](#附件3:2024-07-03收到的邮件/)，签约时间改到了七月六日下午。

### 2024-07-06：签约

![contract](/images/my-next-plan/contract.jpg)_与代理正式签约_

我在中午的时候到了活动地点，居然还是上次的那家中国银行，原来他们有长期合作啊。今天我与 IDP CN 正式签订了合同，虽然我在之前已经收到过合同模版，但我还是逐字检查了合同再签字 —— 这可是一个好习惯呢，对任何需要签字的文件都保持警惕。我将转账回执单通过[邮件](#附件4:2024-07-06发出的邮件/)发给了顾问，因为现在是周末，他们的财务下周一才会将收据开给我。
...
刚刚发了[邮件](#附件5:2024-07-07发出的邮件/)去问 IDP CN 的顾问，不知道会不会耽误申请……
